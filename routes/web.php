...
Route::get('/soda/edit/{sodaId}', 'SodaController@edit')->name('soda.edit');
Route::post('/soda/update/{sodaId}', 'SodaController@update')->name('soda.update');
Route::get('/soda/{sodaId}', 'SodaController@deleteById')->name('soda.delete');
Route::get('/soda/delete/array/{sodaId}', 'SodaController@deleteByArrayId')->name('soda.delete.array');
